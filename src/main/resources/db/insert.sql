...
INSERT INTO qualification(subject,degree_title ,class_of_degree, school,status, start_date,end_date,contact_id)
VALUES ('Yoruba','Bachelor of Art' ,'Pass', 'Lagos State University, Ojo','NO','2015-09-01','2020-07-31', 1),
       ('Economics', 'Bechelor of Science','2nd Class Upper','University of Lagos','NO','2015-09-01','2020-07-31',2);
